...
class PandaEnv():
    ...
    def reset_env(self):
        ...
        self.visualShapeId2 = p.createVisualShape(shapeType=p.GEOM_MESH, fileName='geometry/model_3.obj', rgbaColor=None, meshScale=[0.0002, 0.0002, 0.0002])
        self.collisionShapeId2 = p.createCollisionShape(shapeType=p.GEOM_MESH, fileName='geometry/model_3.obj', meshScale=[0.0002, 0.0002, 0.0002])
